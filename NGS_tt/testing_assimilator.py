...
def parse_file(args):
    ...
    data = pd.read_excel(data_file, "Test Set")
    ...
    with open("classI_log.csv", "w+") as  classI:
        ...
        for variable in ['First', 'Second']:
            ...
            for row in range(rows):
                c_col = "HR_Recip_" + variable + '_C_Split'
                b1_col = "HR_Recip" + '_First_B_Split'
                b2_col = "HR_Recip" + '_Second_B_Split'
            ...
            if (type(R1) != str) or (type(R2) != str):
                ...
                if (type(Q1) != str) or (type(Q2) != str):
                    ...
                    while len(dq_options) > 0:
                        ...
                        print (dq_options[0],options.get(R1))
...
def main(args):
    ...
    rules = pd.read_excel(('/mnt/storage/home/toutoua/projects/tt/NGS_tt/classII_rules.xlsx'))
